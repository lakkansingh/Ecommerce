...
public class HomeSpecialOffersAdapter extends PagedListAdapter<ProductModel, HomeSpecialOffersAdapter.MyViewHolder> {
    ...
    public HomeSpecialOffersAdapter(Context context, ArrayList<ProductModel> productDetailsModelArrayList, Activity activity) {
        super(DIFF_CALLBACK);
        mContext = context;
    ...
    @NonNull
    @Override
    public HomeSpecialOffersAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.frag_main, parent, false);

        return new HomeSpecialOffersAdapter.MyViewHolder(itemView);
    }


    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull HomeSpecialOffersAdapter.MyViewHolder myViewHolder, final int i) {
        ...
        try {
            if (productDetailsModel.getImagesModelArrayList() != null && productDetailsModel.getImagesModelArrayList().size() > 0) {
                Glide.with(mContext)
                        ...
                        .error(R.drawable.offers)//ic_image_place_holder
