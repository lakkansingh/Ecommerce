...
public class HomeSeasonCollectionAdapter extends PagedListAdapter<ProductModel, HomeSeasonCollectionAdapter.MyViewHolder> {
    ...
    public HomeSeasonCollectionAdapter(Context context, ArrayList<ProductModel> productDetailsModelArrayList, Activity activity, int productSetId, String productName) {
        super(DIFF_CALLBACK);
        mContext = context;
    ...
    @NonNull
    @Override
    public HomeSeasonCollectionAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.frag_main, parent, false);

        return new HomeSeasonCollectionAdapter.MyViewHolder(itemView);
    }
        ...
        try {
            if (productDetailsModel.getImagesModelArrayList() != null && productDetailsModel.getImagesModelArrayList().size() > 0) {
                Glide.with(mContext)
                        ...
                        .error(R.drawable.seasn)//ic_image_place_holder
