...
/**
 */
public class HomeTopRecyclerViewAdapter extends PagedListAdapter<ProductModel, HomeTopRecyclerViewAdapter.MyViewHolder> {
    ...
    public HomeTopRecyclerViewAdapter(Context context, ArrayList<ProductModel> productDetailsModelArrayList, Activity activity, int productSetId, String productName) {
        super(DIFF_CALLBACK);
        mContext = context;
    ...
    @NonNull
    @Override
    public HomeTopRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.frag_main, parent, false);

        return new HomeTopRecyclerViewAdapter.MyViewHolder(itemView);
    }
            ...
            myViewHolder.imgIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /* Intent intent = new Intent(AppController.getInstance().getApplicationContext(), ProductListActivity.class);
                    intent.putExtra(PreferManager.PRODUCT_NAME, "New Arrivals");
                    intent.putExtra(PreferManager.PRODUCT_ID, 145);
